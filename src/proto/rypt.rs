...
pub struct RyptFileHeader {
    ...
    #[prost(bytes, tag="8")]
    pub protected_header: std::vec::Vec<u8>,
    /// Which crypto family to use and corresponding config. Required.
    #[prost(oneof="rypt_file_header::CryptoFamily", tags="1")]
    pub crypto_family: ::std::option::Option<rypt_file_header::CryptoFamily>,
}
pub mod rypt_file_header {
    /// Which crypto family to use and corresponding config. Required.
